            ...
            <div class="cart-sub-total">
                <table class="table cart-table">
                    <tbody>
                        <tr>
                            <td class="text-left">Total :</td>
                            <td class="text-right primary-color total-price-guest" id="total-price-guest"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
               ...
               <div class="cart_btn">
                <a href="{{ route('login',['redirect_to' => route('cart')]) }}" class="btn btn-secondary w-100" style="border: 1px solid black; color:black">Checkout</a>
            </div>
