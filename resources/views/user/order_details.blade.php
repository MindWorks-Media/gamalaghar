                                        ...
                                        <div
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="table-responsive">
                                                        <table class="table mb-0 table-borderless" id="table_data">
                                                            <thead style="background-color: #692c91;"
                                                                class="text-light">
                                                                <tr>
                                                                    <th>ID</th>
                                                                    <th>Product Image</th>
                                                            ...
                                                            <tbody class="border-bottom">
                                                                ...
                                                                @forelse ($order->orderItems as $index => $orderItems)
                                                                    ...
                                                                    <tr class="border-bottom">
                                                                        ...
                                                                        <td>
                                                                            @foreach ($productImages as $productImage)
                                                                                @if ($productImage->id == $orderItems->product_id)
                                                                                    {{-- <img src="{{ $productImage->getFirstMediaUrl('product_image') }} sadasd"
                                                                                        alt="{{ $orderItems->product_name }}"
                                                                                        style="max-width: 100px" /> --}}

                                                                                    @if ($productImages[0]['productImages']->isNotEmpty())
                                                                                        @php
                                                                        ...
                                                                        <td>{{ $orderItems->quantity * $orderItems->price }}
                                                                        </td>
                                                                    </tr>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="mb-1"><strong>Name:</strong> {{ $order->user->name }}
                                                    </p>
                                                    <p class="mb-1"><strong>Email:</strong> {{ $order->user->email }}
                                                    </p>
                                                    <p class="mb-1"><strong>Phone:</strong> {{ $order->user->phone }}
                                                    </p>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="mb-1"><strong>Email:</strong>
                                                        {{ $order->shipping_email ? $order->shipping_email : $order->user->email }}
                                                    </p>
                                                    <p class="mb-1"><strong>Phone:</strong>
                                                        {{ $order->shipping_phone ? $order->shipping_phone : $order->user->phone }}
                                                    </p>
                                                    <p class="mb-1"><strong>Address:</strong>
                                                        {{ $order->province . ', ' . $order->city . ', ' . $order->area . ', ' . $order->shipping_address }}
                                                    </p>
